...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Movies = __webpack_require__(220);
	
	var _Movies2 = _interopRequireDefault(_Movies);
	
	var _Mvc = __webpack_require__(247);
	
	var _Mvc2 = _interopRequireDefault(_Mvc);
	
	var _Articles = __webpack_require__(248);
	...
	var Movies = function (_Component) {
	    ...
	    _createClass(Movies, [{
	        ...
	        value: function renderPosts() {
	            ...
	            var filmsNewArray = posts.filter(function (item) {
	                var input2 = _this3.state.text.toLowerCase();
	                var item2 = item.title.toLowerCase();
	            ...
	            return _react2.default.createElement(
	                'div',
	                null,
	                filmsNewArray.map(function (post) {
	                    return _react2.default.createElement(
	                        'div',
	                        { key: post.id, className: 'movies-item' },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Mvc = function (_Component) {
	    ...
	    function Mvc() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Mvc.__proto__ || Object.getPrototypeOf(Mvc)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
	            text: ''
	        }, _this.valueInput = function (e) {
	            _this.setState({ text: e.target.value });
	        }, _temp), _possibleConstructorReturn(_this, _ret);
	    ...
	    _createClass(Mvc, [{
	        ...
	        value: function render() {
	            ...
	            var mvcTemplate = void 0;
	            mvcTemplate = array.filter(function (item) {
	                if (item.indexOf(_this2.state.text) >= 0) {
	                    return true;
	                }
	            });
